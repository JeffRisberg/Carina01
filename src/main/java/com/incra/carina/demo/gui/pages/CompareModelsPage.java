package com.incra.carina.demo.gui.pages;

import com.incra.carina.demo.gui.components.compare.CondidateBlock;
  ...
  public List<ModelSpecs> compareModels(String... models) {
    ...
    for (int index = 0; index < models.length; index++) {
      ...
      for (ModelSpecs.SpecType type : ModelSpecs.SpecType.values()) {
        ExtendedWebElement spec =
            findExtendedWebElement(
                By.xpath(
                    String.format(
                        "//tr[.//a[text()='%s']]//td[@class='nfo'][%d]",
