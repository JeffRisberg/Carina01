...
import com.incra.carina.demo.gui.components.FooterMenu;
import com.incra.carina.demo.gui.components.NewsItem;
import com.incra.carina.demo.gui.components.compare.ModelSpecs;
import com.incra.carina.demo.gui.components.compare.ModelSpecs.SpecType;
import com.incra.carina.demo.gui.pages.BrandModelsPage;
import com.incra.carina.demo.gui.pages.CompareModelsPage;
import com.incra.carina.demo.gui.pages.HomePage;
import com.incra.carina.demo.gui.pages.ModelInfoPage;
import com.incra.carina.demo.gui.pages.NewsPage;
...
public class WebSampleTest extends AbstractTest {
  ...
  public void testCompareModels() {
    ...
    // Compare 3 models
    List<ModelSpecs> specs =
        comparePage.compareModels(
            "Samsung Galaxy J3", "Samsung Galaxy J5", "Samsung Galaxy J7 Pro");
  ...
  public void testNewsSearch() {
    ...
    for (NewsItem n : news) {
      ...
      Assert.assertTrue(
          StringUtils.containsIgnoreCase(n.readTitle(), searchQ), "Invalid search results!");
    }
  }
}
